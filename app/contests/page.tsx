          ...
          <div className="relative overflow-hidden rounded-[32px] aspect-[16/6] flex items-center group">
            ...
            <div className="absolute top-8 left-8 z-20">
              <div className="flex items-center gap-3">
                <div className="w-1 h-12 bg-gradient-to-b from-amber-400 via-orange-400 to-yellow-400 rounded-full"></div>
                <div className="px-5 py-2.5 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
                  <div className="flex items-center gap-2">
                    <Trophy className="w-3 h-3 text-white" />
                    <span className="text-[10px] uppercase tracking-[0.25em] text-white font-bold">Contests</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative px-8 md:px-16 py-16 md:py-20 text-left max-w-5xl z-20">
              ...
              <div className="flex items-center gap-4 mb-6">
                <p className="text-xl md:text-2xl text-white/90 font-light">コンテスト一覧</p>
