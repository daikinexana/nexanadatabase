  ...
  const contests = [
    {
      ...
      targetArea: "交通・インフラ",
      targetAudience: "スタートアップ、中小企業",
      incentive: "最大500万円の支援金、事業化支援",
      operatingCompany: "東日本高速道路株式会社",
      isActive: true,
    },
    {
      ...
      targetArea: "地域活性、ヘルスケア、ものづくり",
      targetAudience: "スタートアップ、中小企業、個人事業主",
      incentive: "最大300万円の支援金、メンタリング支援",
      operatingCompany: "埼玉県",
      isActive: true,
    },
    {
      ...
      targetArea: "3Dプリンター、シミュレーション、精製、プロセスイノベーション",
      targetAudience: "スタートアップ、中小企業、研究機関",
      incentive: "最大1000万円の支援金、技術支援、事業化支援",
      operatingCompany: "旭化成株式会社",
      isActive: true,
    },
  ];
  ...
  for (const contestData of contests) {
    const contest = await prisma.contest.create({
      data: {
        ...
        area: contestData.area,
        organizer: contestData.organizer,
        organizerType: contestData.organizerType,
        website: contestData.website,
        targetArea: contestData.targetArea,
        targetAudience: contestData.targetAudience,
        incentive: contestData.incentive,
        operatingCompany: contestData.operatingCompany,
